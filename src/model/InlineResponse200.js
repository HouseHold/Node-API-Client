...
import ProductCategoryjsonld from './ProductCategoryjsonld';
...
class InlineResponse200 {
     ...
     * @param hydramember {Array.<module:model/ProductCategoryjsonld>} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('hydra:member')) {
                obj['hydra:member'] = ApiClient.convertToType(data['hydra:member'], [ProductCategoryjsonld]);
            }
...
/**
 * @member {Array.<module:model/ProductCategoryjsonld>} hydra:member
 */
