...
export interface InlineResponse2003 {
  /**
   *
   * @type {Array<ProductManufacturerjsonld>}
   * @memberof InlineResponse2003
   */
  hydramember: Array<ProductManufacturerjsonld>;
  /**
   *
   * @type {number}
   * @memberof InlineResponse2003
 ...
 *
 * @export
 * @interface ProductManufacturerjsonld
 */
export interface ProductManufacturerjsonld {
  /**
   *
   * @type {string}
   * @memberof ProductManufacturerjsonld
   */
  '@context': string;
  /**
   *
  ...
  return {
    ...
    deleteProductItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteProductItem."
        );
      }
    ...
    getProductItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getProductItem."
        );
      }
      const localVarPath = `/api/products/{id}`.replace(
        `{${"id"}}`,
    ...
    patchProductItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling patchProductItem."
        );
      }
      const localVarPath = `/api/products/{id}`.replace(
        `{${"id"}}`,
    ...
    postProductCollection(
      ...
      const needsSerialization =
        typeof productjsonld !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(productjsonld !== undefined ? productjsonld : {})
        : productjsonld || "";
    ...
    putProductItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling putProductItem."
        );
      }
      const localVarPath = `/api/products/{id}`.replace(
        `{${"id"}}`,
...
export const ProductApiFp = function(configuration?: Configuration) {
  return {
    ...
    deleteProductItem(
      ...
      const localVarAxiosArgs = ProductApiAxiosParamCreator(
        configuration
    ...
    getProductCollection(
      ...
      const localVarAxiosArgs = ProductApiAxiosParamCreator(
        configuration
      ).getProductCollection(name, page, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    patchProductItem(
      ...
      const localVarAxiosArgs = ProductApiAxiosParamCreator(
        configuration
      ).patchProductItem(id, product, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    postProductCollection(
      ...
      const localVarAxiosArgs = ProductApiAxiosParamCreator(
        configuration
      ).postProductCollection(productjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    putProductItem(
      ...
      const localVarAxiosArgs = ProductApiAxiosParamCreator(
        configuration
      ).putProductItem(id, productjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
...
export class ProductApi extends BaseAPI {
  ...
  public deleteProductItem(id: string, options?: any) {
    return ProductApiFp(this.configuration).deleteProductItem(id, options)(
      this.axios,
      this.basePath
    );
  }
  ...
  public getProductCollection(name?: string, page?: number, options?: any) {
    return ProductApiFp(this.configuration).getProductCollection(
      name,
      page,
      options
  ...
  public getProductItem(id: string, options?: any) {
    return ProductApiFp(this.configuration).getProductItem(id, options)(
      this.axios,
      this.basePath
    );
  }
  ...
  public patchProductItem(id: string, product?: Product, options?: any) {
    return ProductApiFp(this.configuration).patchProductItem(
      id,
      product,
      options
    )(this.axios, this.basePath);
  ...
  public postProductCollection(productjsonld?: Productjsonld, options?: any) {
    return ProductApiFp(this.configuration).postProductCollection(
      productjsonld,
      options
    )(this.axios, this.basePath);
  }
  ...
  public putProductItem(
    ...
    return ProductApiFp(this.configuration).putProductItem(
      id,
      productjsonld,
      options
    )(this.axios, this.basePath);
 ...
 * @export
 */
export const ProductCategoryApiAxiosParamCreator = function(
  configuration?: Configuration
) {
  return {
    /**
    ...
    deleteProductCategoryItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteProductCategoryItem."
        );
      }
      const localVarPath = `/api/product/categories/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    getProductCategoryItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getProductCategoryItem."
        );
      }
      const localVarPath = `/api/product/categories/{id}`.replace(
        `{${"id"}}`,
    ...
    patchProductCategoryItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling patchProductCategoryItem."
        );
      }
      const localVarPath = `/api/product/categories/{id}`.replace(
        `{${"id"}}`,
      ...
      const needsSerialization =
        ...
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(productCategory !== undefined ? productCategory : {})
        : productCategory || "";
    ...
    postProductCategoryCollection(
      ...
      const needsSerialization =
        typeof productCategoryjsonld !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            productCategoryjsonld !== undefined ? productCategoryjsonld : {}
          )
    ...
    putProductCategoryItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling putProductCategoryItem."
        );
      }
      const localVarPath = `/api/product/categories/{id}`.replace(
        `{${"id"}}`,
...
export const ProductCategoryApiFp = function(configuration?: Configuration) {
  return {
    ...
    deleteProductCategoryItem(
      ...
      const localVarAxiosArgs = ProductCategoryApiAxiosParamCreator(
        configuration
      ).deleteProductCategoryItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductCategoryCollection(
      ...
      const localVarAxiosArgs = ProductCategoryApiAxiosParamCreator(
        configuration
      ).getProductCategoryCollection(page, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductCategoryItem(
      ...
      const localVarAxiosArgs = ProductCategoryApiAxiosParamCreator(
        configuration
      ).getProductCategoryItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    patchProductCategoryItem(
      ...
      const localVarAxiosArgs = ProductCategoryApiAxiosParamCreator(
        configuration
      ).patchProductCategoryItem(id, productCategory, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    postProductCategoryCollection(
      ...
      const localVarAxiosArgs = ProductCategoryApiAxiosParamCreator(
        configuration
      ).postProductCategoryCollection(productCategoryjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    putProductCategoryItem(
      ...
      const localVarAxiosArgs = ProductCategoryApiAxiosParamCreator(
        configuration
      ).putProductCategoryItem(id, productCategoryjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const ProductCategoryApiFactory = function(
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class ProductCategoryApi extends BaseAPI {
  ...
  public deleteProductCategoryItem(id: string, options?: any) {
    return ProductCategoryApiFp(this.configuration).deleteProductCategoryItem(
      id,
      options
    )(this.axios, this.basePath);
  }
  ...
  public getProductCategoryCollection(page?: number, options?: any) {
    return ProductCategoryApiFp(
      this.configuration
    ).getProductCategoryCollection(page, options)(this.axios, this.basePath);
  }
  ...
  public getProductCategoryItem(id: string, options?: any) {
    return ProductCategoryApiFp(this.configuration).getProductCategoryItem(
      id,
      options
    )(this.axios, this.basePath);
  }
   ...
   * @memberof ProductCategoryApi
   */
  public patchProductCategoryItem(
    id: string,
    productCategory?: ProductCategory,
    options?: any
  ) {
    return ProductCategoryApiFp(this.configuration).patchProductCategoryItem(
      id,
      productCategory,
      options
    )(this.axios, this.basePath);
   ...
   * @memberof ProductCategoryApi
   */
  public postProductCategoryCollection(
    productCategoryjsonld?: ProductCategoryjsonld,
    options?: any
  ) {
    return ProductCategoryApiFp(
   ...
   * @memberof ProductCategoryApi
   */
  public putProductCategoryItem(
    id: string,
    productCategoryjsonld?: ProductCategoryjsonld,
    options?: any
  ) {
    return ProductCategoryApiFp(this.configuration).putProductCategoryItem(
      id,
      productCategoryjsonld,
      options
    )(this.axios, this.basePath);
 ...
 * @export
 */
export const ProductCollectionApiAxiosParamCreator = function(
  configuration?: Configuration
) {
  return {
    /**
    ...
    deleteProductCollectionItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteProductCollectionItem."
        );
      }
      const localVarPath = `/api/product/collections/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    getProductCollectionItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getProductCollectionItem."
        );
      }
      const localVarPath = `/api/product/collections/{id}`.replace(
        `{${"id"}}`,
    ...
    patchProductCollectionItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling patchProductCollectionItem."
        );
      }
      const localVarPath = `/api/product/collections/{id}`.replace(
        `{${"id"}}`,
      ...
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            productCollection !== undefined ? productCollection : {}
          )
        : productCollection || "";
    ...
    postProductCollectionCollection(
      ...
      const needsSerialization =
        typeof productCollectionjsonld !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            productCollectionjsonld !== undefined ? productCollectionjsonld : {}
          )
    ...
    putProductCollectionItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling putProductCollectionItem."
        );
      }
      const localVarPath = `/api/product/collections/{id}`.replace(
        `{${"id"}}`,
...
export const ProductCollectionApiFp = function(configuration?: Configuration) {
  return {
    ...
    deleteProductCollectionItem(
      ...
      const localVarAxiosArgs = ProductCollectionApiAxiosParamCreator(
        configuration
      ).deleteProductCollectionItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductCollectionCollection(
      ...
      const localVarAxiosArgs = ProductCollectionApiAxiosParamCreator(
        configuration
      ).getProductCollectionCollection(page, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductCollectionItem(
      ...
      const localVarAxiosArgs = ProductCollectionApiAxiosParamCreator(
        configuration
      ).getProductCollectionItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    patchProductCollectionItem(
      ...
      const localVarAxiosArgs = ProductCollectionApiAxiosParamCreator(
        configuration
      ).patchProductCollectionItem(id, productCollection, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    putProductCollectionItem(
      ...
      const localVarAxiosArgs = ProductCollectionApiAxiosParamCreator(
        configuration
      ).putProductCollectionItem(id, productCollectionjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const ProductCollectionApiFactory = function(
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class ProductCollectionApi extends BaseAPI {
  ...
  public deleteProductCollectionItem(id: string, options?: any) {
    return ProductCollectionApiFp(
      this.configuration
    ).deleteProductCollectionItem(id, options)(this.axios, this.basePath);
  }
  ...
  public getProductCollectionCollection(page?: number, options?: any) {
    return ProductCollectionApiFp(
      this.configuration
    ).getProductCollectionCollection(page, options)(this.axios, this.basePath);
  }
  ...
  public getProductCollectionItem(id: string, options?: any) {
    return ProductCollectionApiFp(this.configuration).getProductCollectionItem(
      id,
      options
    )(this.axios, this.basePath);
  }
   ...
   * @memberof ProductCollectionApi
   */
  public patchProductCollectionItem(
    id: string,
    productCollection?: ProductCollection,
    options?: any
  ) {
   ...
   * @memberof ProductCollectionApi
   */
  public postProductCollectionCollection(
    productCollectionjsonld?: ProductCollectionjsonld,
    options?: any
  ) {
    return ProductCollectionApiFp(
   ...
   * @memberof ProductCollectionApi
   */
  public putProductCollectionItem(
    id: string,
    productCollectionjsonld?: ProductCollectionjsonld,
    options?: any
  ) {
    return ProductCollectionApiFp(this.configuration).putProductCollectionItem(
      id,
      productCollectionjsonld,
      options
    )(this.axios, this.basePath);
 ...
 * @export
 */
export const ProductLocationApiAxiosParamCreator = function(
  configuration?: Configuration
) {
  return {
    /**
    ...
    deleteProductLocationItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteProductLocationItem."
        );
      }
      const localVarPath = `/api/product/locations/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    getProductLocationItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getProductLocationItem."
        );
      }
      const localVarPath = `/api/product/locations/{id}`.replace(
        `{${"id"}}`,
    ...
    patchProductLocationItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling patchProductLocationItem."
        );
      }
      const localVarPath = `/api/product/locations/{id}`.replace(
        `{${"id"}}`,
      ...
      const needsSerialization =
        ...
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(productLocation !== undefined ? productLocation : {})
        : productLocation || "";
    ...
    postProductLocationCollection(
      ...
      const needsSerialization =
        typeof productLocationjsonld !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            productLocationjsonld !== undefined ? productLocationjsonld : {}
          )
    ...
    putProductLocationItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling putProductLocationItem."
        );
      }
      const localVarPath = `/api/product/locations/{id}`.replace(
        `{${"id"}}`,
...
export const ProductLocationApiFp = function(configuration?: Configuration) {
  return {
    ...
    deleteProductLocationItem(
      ...
      const localVarAxiosArgs = ProductLocationApiAxiosParamCreator(
        configuration
      ).deleteProductLocationItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductLocationCollection(
      ...
      const localVarAxiosArgs = ProductLocationApiAxiosParamCreator(
        configuration
      ).getProductLocationCollection(page, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductLocationItem(
      ...
      const localVarAxiosArgs = ProductLocationApiAxiosParamCreator(
        configuration
      ).getProductLocationItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    patchProductLocationItem(
      ...
      const localVarAxiosArgs = ProductLocationApiAxiosParamCreator(
        configuration
      ).patchProductLocationItem(id, productLocation, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    postProductLocationCollection(
      ...
      const localVarAxiosArgs = ProductLocationApiAxiosParamCreator(
        configuration
      ).postProductLocationCollection(productLocationjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    putProductLocationItem(
      ...
      const localVarAxiosArgs = ProductLocationApiAxiosParamCreator(
        configuration
      ).putProductLocationItem(id, productLocationjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const ProductLocationApiFactory = function(
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class ProductLocationApi extends BaseAPI {
  ...
  public deleteProductLocationItem(id: string, options?: any) {
    return ProductLocationApiFp(this.configuration).deleteProductLocationItem(
      id,
      options
    )(this.axios, this.basePath);
  }
  ...
  public getProductLocationCollection(page?: number, options?: any) {
    return ProductLocationApiFp(
      this.configuration
    ).getProductLocationCollection(page, options)(this.axios, this.basePath);
  }
  ...
  public getProductLocationItem(id: string, options?: any) {
    return ProductLocationApiFp(this.configuration).getProductLocationItem(
      id,
      options
    )(this.axios, this.basePath);
  }
   ...
   * @memberof ProductLocationApi
   */
  public patchProductLocationItem(
    id: string,
    productLocation?: ProductLocation,
    options?: any
  ) {
    return ProductLocationApiFp(this.configuration).patchProductLocationItem(
      id,
      productLocation,
      options
    )(this.axios, this.basePath);
   ...
   * @memberof ProductLocationApi
   */
  public postProductLocationCollection(
    productLocationjsonld?: ProductLocationjsonld,
    options?: any
  ) {
    return ProductLocationApiFp(
   ...
   * @memberof ProductLocationApi
   */
  public putProductLocationItem(
    id: string,
    productLocationjsonld?: ProductLocationjsonld,
    options?: any
  ) {
    return ProductLocationApiFp(this.configuration).putProductLocationItem(
      id,
      productLocationjsonld,
      options
    )(this.axios, this.basePath);
...
/**
 * ProductManufacturerApi - axios parameter creator
 * @export
 */
export const ProductManufacturerApiAxiosParamCreator = function(
  configuration?: Configuration
) {
  return {
    /**
     *
     * @summary Removes the ProductManufacturer resource.
     * @param {string} id
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    deleteProductManufacturerItem(id: string, options: any = {}): RequestArgs {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteProductManufacturerItem."
        );
      }
      const localVarPath = `/api/product/manufacturers/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    /**
     *
     * @summary Retrieves the collection of ProductManufacturer resources.
     * @param {number} [page] The collection page number
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getProductManufacturerCollection(
      page?: number,
      options: any = {}
    ): RequestArgs {
      const localVarPath = `/api/product/manufacturers`;
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
      let baseOptions;
      if (configuration) {
        baseOptions = configuration.baseOptions;
    ...
    /**
     *
     * @summary Retrieves a ProductManufacturer resource.
     * @param {string} id
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    getProductManufacturerItem(id: string, options: any = {}): RequestArgs {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getProductManufacturerItem."
        );
      }
      const localVarPath = `/api/product/manufacturers/{id}`.replace(
        `{${"id"}}`,
    ...
    /**
     *
     * @summary Updates the ProductManufacturer resource.
     * @param {string} id
     * @param {ProductManufacturer} [productManufacturer] The updated ProductManufacturer resource
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    patchProductManufacturerItem(
      id: string,
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling patchProductManufacturerItem."
        );
      }
      const localVarPath = `/api/product/manufacturers/{id}`.replace(
        `{${"id"}}`,
      ...
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            productManufacturer !== undefined ? productManufacturer : {}
          )
        : productManufacturer || "";
    ...
    /**
     *
     * @summary Creates a ProductManufacturer resource.
     * @param {ProductManufacturerjsonld} [productManufacturerjsonld] The new ProductManufacturer resource
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    postProductManufacturerCollection(
      productManufacturerjsonld?: ProductManufacturerjsonld,
      options: any = {}
    ): RequestArgs {
      const localVarPath = `/api/product/manufacturers`;
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
      ...
      const needsSerialization =
        typeof productManufacturerjsonld !== "string" ||
        localVarRequestOptions.headers["Content-Type"] === "application/json";
      localVarRequestOptions.data = needsSerialization
        ? JSON.stringify(
            productManufacturerjsonld !== undefined
              ? productManufacturerjsonld
              : {}
          )
        : productManufacturerjsonld || "";
    ...
    /**
     *
     * @summary Replaces the ProductManufacturer resource.
     * @param {string} id
     * @param {ProductManufacturerjsonld} [productManufacturerjsonld] The updated ProductManufacturer resource
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    putProductManufacturerItem(
      id: string,
      productManufacturerjsonld?: ProductManufacturerjsonld,
      options: any = {}
    ): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling putProductManufacturerItem."
        );
      }
      const localVarPath = `/api/product/manufacturers/{id}`.replace(
        `{${"id"}}`,
...
/**
 * ProductManufacturerApi - functional programming interface
 * @export
 */
export const ProductManufacturerApiFp = function(
  configuration?: Configuration
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    deleteProductManufacturerItem(
      id: string,
      options?: any
    ): (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void> {
      const localVarAxiosArgs = ProductManufacturerApiAxiosParamCreator(
        configuration
      ).deleteProductManufacturerItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    getProductManufacturerCollection(
      ...
      const localVarAxiosArgs = ProductManufacturerApiAxiosParamCreator(
        configuration
      ).getProductManufacturerCollection(page, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
     ...
     * @throws {RequiredError}
     */
    getProductManufacturerItem(
      id: string,
      options?: any
    ): (
      axios?: AxiosInstance,
      basePath?: string
    ) => AxiosPromise<ProductManufacturerjsonld> {
      const localVarAxiosArgs = ProductManufacturerApiAxiosParamCreator(
        configuration
      ).getProductManufacturerItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    patchProductManufacturerItem(
      ...
      const localVarAxiosArgs = ProductManufacturerApiAxiosParamCreator(
        configuration
      ).patchProductManufacturerItem(id, productManufacturer, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    postProductManufacturerCollection(
      ...
      const localVarAxiosArgs = ProductManufacturerApiAxiosParamCreator(
        configuration
      ).postProductManufacturerCollection(productManufacturerjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    putProductManufacturerItem(
      ...
      const localVarAxiosArgs = ProductManufacturerApiAxiosParamCreator(
        configuration
      ).putProductManufacturerItem(id, productManufacturerjsonld, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
...
/**
 * ProductManufacturerApi - factory interface
 * @export
 */
export const ProductManufacturerApiFactory = function(
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    deleteProductManufacturerItem(
      ...
      return ProductManufacturerApiFp(
        configuration
      ).deleteProductManufacturerItem(id, options)(axios, basePath);
    },
    /**
     *
     * @summary Retrieves the collection of ProductManufacturer resources.
    ...
    getProductManufacturerCollection(
      ...
      return ProductManufacturerApiFp(
        configuration
      ).getProductManufacturerCollection(page, options)(axios, basePath);
    },
    /**
     *
     * @summary Retrieves a ProductManufacturer resource.
    ...
    getProductManufacturerItem(
      ...
      return ProductManufacturerApiFp(configuration).getProductManufacturerItem(
        id,
        options
      )(axios, basePath);
    },
    ...
    putProductManufacturerItem(
      ...
      return ProductManufacturerApiFp(configuration).putProductManufacturerItem(
        id,
        productManufacturerjsonld,
        options
      )(axios, basePath);
...
/**
 * ProductManufacturerApi - object-oriented interface
 * @export
 * @class ProductManufacturerApi
 * @extends {BaseAPI}
 */
export class ProductManufacturerApi extends BaseAPI {
  /**
   *
   * @summary Removes the ProductManufacturer resource.
   * @param {string} id
   * @param {*} [options] Override http request option.
   * @throws {RequiredError}
   * @memberof ProductManufacturerApi
   */
  public deleteProductManufacturerItem(id: string, options?: any) {
    return ProductManufacturerApiFp(
      this.configuration
    ).deleteProductManufacturerItem(id, options)(this.axios, this.basePath);
  }
   ...
   * @memberof ProductManufacturerApi
   */
  public getProductManufacturerCollection(page?: number, options?: any) {
    return ProductManufacturerApiFp(
      this.configuration
    ).getProductManufacturerCollection(page, options)(
      this.axios,
   ...
   * @memberof ProductManufacturerApi
   */
  public getProductManufacturerItem(id: string, options?: any) {
    return ProductManufacturerApiFp(
      this.configuration
    ).getProductManufacturerItem(id, options)(this.axios, this.basePath);
  }
   ...
   * @memberof ProductManufacturerApi
   */
  public patchProductManufacturerItem(
    id: string,
    productManufacturer?: ProductManufacturer,
    options?: any
  ) {
   ...
   * @memberof ProductManufacturerApi
   */
  public postProductManufacturerCollection(
    productManufacturerjsonld?: ProductManufacturerjsonld,
    options?: any
  ) {
    return ProductManufacturerApiFp(
   ...
   * @memberof ProductManufacturerApi
   */
  public putProductManufacturerItem(
    id: string,
    productManufacturerjsonld?: ProductManufacturerjsonld,
    options?: any
  ) {
 ...
 * @export
 */
export const ProductStockApiAxiosParamCreator = function(
  configuration?: Configuration
) {
  return {
    /**
    ...
    getProductStockItem(id: string, options: any = {}): RequestArgs {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getProductStockItem."
        );
      }
      const localVarPath = `/api/product/stocks/{id}`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    stockAddProductStockItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling stockAddProductStockItem."
        );
      }
      ...
      if (inlineObject1 === null || inlineObject1 === undefined) {
        throw new RequiredError(
          "inlineObject1",
          "Required parameter inlineObject1 was null or undefined when calling stockAddProductStockItem."
        );
      }
      const localVarPath = `/api/product/stocks/{id}/add`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
    ...
    stockConsumeProductStockItem(
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling stockConsumeProductStockItem."
        );
      }
      ...
      if (inlineObject2 === null || inlineObject2 === undefined) {
        throw new RequiredError(
          "inlineObject2",
          "Required parameter inlineObject2 was null or undefined when calling stockConsumeProductStockItem."
        );
      }
      const localVarPath = `/api/product/stocks/{id}/consume`.replace(
        `{${"id"}}`,
        encodeURIComponent(String(id))
      );
      const localVarUrlObj = globalImportUrl.parse(localVarPath, true);
...
export const ProductStockApiFp = function(configuration?: Configuration) {
  return {
    ...
    getProductStockCollection(
      ...
      const localVarAxiosArgs = ProductStockApiAxiosParamCreator(
        configuration
      ).getProductStockCollection(
        quantity,
        quantity2,
    ...
    getProductStockItem(
      ...
      const localVarAxiosArgs = ProductStockApiAxiosParamCreator(
        configuration
      ).getProductStockItem(id, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    stockAddProductStockItem(
      ...
      const localVarAxiosArgs = ProductStockApiAxiosParamCreator(
        configuration
      ).stockAddProductStockItem(id, inlineObject1, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    stockConsumeProductStockItem(
      ...
      const localVarAxiosArgs = ProductStockApiAxiosParamCreator(
        configuration
      ).stockConsumeProductStockItem(id, inlineObject2, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
    ...
    stockInitProductStockCollection(
      ...
      const localVarAxiosArgs = ProductStockApiAxiosParamCreator(
        configuration
      ).stockInitProductStockCollection(inlineObject, options);
      return (
        axios: AxiosInstance = globalAxios,
        basePath: string = BASE_PATH
      ) => {
 ...
 * @export
 */
export const ProductStockApiFactory = function(
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
...
export class ProductStockApi extends BaseAPI {
   ...
   */
  public getProductStockCollection(
    quantity?: number,
    quantity2?: Array<number>,
    location?: string,
    location2?: Array<string>,
    ...
    return ProductStockApiFp(this.configuration).getProductStockCollection(
      quantity,
      quantity2,
      location,
      location2,
  ...
  public getProductStockItem(id: string, options?: any) {
    return ProductStockApiFp(this.configuration).getProductStockItem(
      id,
      options
    )(this.axios, this.basePath);
  }
   ...
   * @memberof ProductStockApi
   */
  public stockAddProductStockItem(
    id: string,
    inlineObject1: InlineObject1,
    options?: any
  ) {
    return ProductStockApiFp(this.configuration).stockAddProductStockItem(
      id,
      inlineObject1,
      options
    )(this.axios, this.basePath);
   ...
   * @memberof ProductStockApi
   */
  public stockConsumeProductStockItem(
    id: string,
    inlineObject2: InlineObject2,
    options?: any
  ) {
    return ProductStockApiFp(this.configuration).stockConsumeProductStockItem(
      id,
      inlineObject2,
      options
    )(this.axios, this.basePath);
   ...
   * @memberof ProductStockApi
   */
  public stockInitProductStockCollection(
    inlineObject?: InlineObject,
    options?: any
  ) {
    return ProductStockApiFp(
      this.configuration
    ).stockInitProductStockCollection(inlineObject, options)(
      this.axios,
      this.basePath
